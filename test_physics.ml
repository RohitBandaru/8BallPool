...
let nw = Ball.create_ball "nw" 0 Cue "red" (-.1.0, 1.0) (0.5, -.0.5) 5.0 1.0
let sw = Ball.create_ball "sw" 0 Cue "red" (-.1.0, -.1.0) (0.0, 0.0) 5.0 1.0
let ne = Ball.create_ball "ne" 0 Cue "red" (1.0, 1.0) (-.0.5, -.0.5) 5.0 1.0
let se = Ball.create_ball "se" 0 Cue "red" (1.0, -.1.0) (-.0.5, 0.5) 5.0 1.0
let n  = Ball.create_ball "n" 0 Cue "red" (0.0, 1.0) (0.0, 0.0) 5.0 1.0
let s  = Ball.create_ball "s" 0 Cue "red" (0.0, -.1.0) (0.0, 0.0) 5.0 1.0
let e  = Ball.create_ball "e" 0 Cue "red" (1.0, 0.0) (0.0, 0.0) 5.0 1.0
let w  = Ball.create_ball "w" 0 Cue "red" (-.1.0, 0.0) (-.1.0, 0.0) 5.0 1.0
let c = Ball.create_ball "a" 0 Cue "red" (0.0, 0.0) (0.0, 0.0) 5.0 1.0
